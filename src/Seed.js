...
var Seed = (function(){
    ...
    function Seed(seed,type,id,ownerId,seedId,status,nextStsTime,cnt,originalIncome,rich,wettability,illuminance,health,totalIncome,steal,totalStael,sWater,oWater,fruitId){
        this.seed = seed;//种子 
        //种子类型默认全部先传1
        this.type = type;//类型
        /*数据参数start*/
